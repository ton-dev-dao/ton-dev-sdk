...
#[tokio::test]
async fn test_crypto_boxes() -> ton_dev_block::Result<()> {
    let client = Arc::new(TestClient::new());
    let password_hash =
...
#[tokio::test]
async fn test_crypto_box_signing_boxes() -> ton_dev_block::Result<()> {
    let client = Arc::new(TestClient::new());
    let password_hash =
        Arc::new("1234567890ABCDEF1234567890ABCDEF1234567890ABCDEF1234567890ABCDEF".to_string());
    let salt = "123123123";
...
#[tokio::test]
async fn test_crypto_box_encryption_boxes() -> ton_dev_block::Result<()> {
    let client = Arc::new(TestClient::new());
    let password_hash =
        Arc::new("1234567890ABCDEF1234567890ABCDEF1234567890ABCDEF1234567890ABCDEF".to_string());
    let nonce = "ff".repeat(12);
...
#[tokio::test]
async fn test_crypto_box_derive_key_cache() -> ton_dev_block::Result<()> {
    let client = Arc::new(TestClient::new());
    let password_hash =
        Arc::new("1234567890ABCDEF1234567890ABCDEF1234567890ABCDEF1234567890ABCDEF".to_string());
    let salt = "123123123";
