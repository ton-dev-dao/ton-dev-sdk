...
use std::fmt::Display;
use std::sync::Arc;
use ton_dev_block::{Message, MsgAddressExt, Serializable};
...
pub fn prepare_ext_in_message(
...
) -> Result<(u32, u32, u32, ton_dev_block::MsgAddressInt, Message), String> {
    ...
    let dst_addr: ton_dev_block::MsgAddressInt = hdr.dst.clone();
