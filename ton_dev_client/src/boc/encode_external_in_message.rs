...
use std::str::FromStr;
use ton_dev_block::{ExternalInboundMessageHeader, GetRepresentationHash, MsgAddressExt, StateInit};
...
pub fn encode_external_in_message(
    ...
    let mut msg = ton_dev_block::Message::with_ext_in_header(header);
