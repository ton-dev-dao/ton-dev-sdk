...
fn test_address_parsing() {
    ...
    let address = ton_dev_block::MsgAddressInt::with_standart(None, -1, hex::decode(short).unwrap().into()).unwrap();
    let wc0_address = ton_dev_block::MsgAddressInt::with_standart(None, 0, hex::decode(short).unwrap().into()).unwrap();
